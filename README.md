...
> Be patient! In ~3 mins your app is live, at your [app url](https://container--zinzr4.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container--zinzr4.containers.anotherwebservice.com/
...
```
git clone git@github.com:Eapalmoms/container--zinzr4.git
cd container--zinzr4
```
...
```
docker attach container--zinzr4
```
